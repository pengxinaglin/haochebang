    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneView.getText()==null || TextUtils.isEmpty(phoneView.getText().toString().trim())) {
                ...
                if (priceView.getText()==null || TextUtils.isEmpty(priceView.getText().toString().trim())) {
               ...
               final String price =priceView.getText().toString().trim();
                ...
                if (commentView.getText()==null || TextUtils.isEmpty(commentView.getText().toString().trim())) {
