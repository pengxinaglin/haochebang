...
public class CancleTaskPhotoAdapter extends HCCommonAdapter<String> {


	public CancleTaskPhotoAdapter(Context context, List<String> data, int layoutId) {
		super(context, data, layoutId);
	}

	@Override
	public void fillViewData(HCCommonViewHolder holder, int position) {
//		View view = mInflater.inflate(R.layout.activity_cancel_task_gvitem, parent, false);
		ImageView iv_photo = holder.findTheView(R.id.iv_upload_photo);
