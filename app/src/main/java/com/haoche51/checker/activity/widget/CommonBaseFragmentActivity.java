 ...
 */
public abstract class CommonBaseFragmentActivity extends FragmentActivity implements Validator.ValidationListener, HCHttpCallback {
  ...
  /* titlebar return*/
    ...
    public CommonBaseFragmentActivity() {
