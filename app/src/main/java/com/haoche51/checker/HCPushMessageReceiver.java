	...
	public void onBind(Context context, int errorCode, String appId, String userId, String channelId, String requestId) {
		...
		if (errorCode == 0 && userId != null && channelId != null) {
			...
			if (GlobalData.userDataHelper.getPushId() == 0 ||
				GlobalData.userDataHelper.getPushChannelId() == null ||
				!GlobalData.userDataHelper.getPushChannelId().equals(channelId) ||
				GlobalData.userDataHelper.getPushUserId() == null ||
				...
				OKHttpManager.getInstance().post(HCHttpRequestParam.bind(userId, channelId), HCPushMessageReceiver.this, 0);
			}
		}
	}
