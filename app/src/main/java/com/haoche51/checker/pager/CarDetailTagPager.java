 ...
 */
public class CarDetailTagPager extends BaseTagPager {

  public CarDetailTagPager(Activity mActivity) {
    super(mActivity);
  }
  ...
  public void onItemClick(View view, int position) {
    ...
    if (this.onTagSelectedListener != null)
      this.onTagSelectedListener.onTagSelected((String) map.get("tagName"), PictureConstants.DETAIL_PICTURE_CHOSE, position , (Integer) photoTags.get(position).get("enumeration"));
  }
}
