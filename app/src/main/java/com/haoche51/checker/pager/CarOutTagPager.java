 ...
 */
public class CarOutTagPager extends BaseTagPager {

  public CarOutTagPager(Activity mActivity) {
    super(mActivity);
  }
  ...
  public void onItemClick(View view, int position) {
    ...
    if (this.onTagSelectedListener != null)
	    this.onTagSelectedListener.onTagSelected((String) map.get("tagName"), PictureConstants.OUTER_PICTURE_CHOSE, position , (Integer) photoTags.get(position).get("enumeration"));
  }
}
