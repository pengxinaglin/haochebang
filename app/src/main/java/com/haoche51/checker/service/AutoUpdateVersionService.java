...
import com.haoche51.checker.activity.DownloadDialogActivity;
import com.haoche51.checker.activity.UpdateConfirmDialogActivity;
...
public class AutoUpdateVersionService extends Service {
    ...
    private void checkDownloadStatus() {
        ...
        if (downloadId == -1L) {
            OKHttpManager.getInstance().post(HCHttpRequestParam.checkVersion(DeviceInfoUtil.getAppCurrVersion()), new CheckVersionCallBack(), 0);
    ...
    public void onEventMainThread(UpdateServiceEntity updateService) {
        ...
        FileDownloadUtil.startDownload(mVersionEntity.getUrl(), System.currentTimeMillis() + ".apk", "好车邦", "版本更新中");
    }
