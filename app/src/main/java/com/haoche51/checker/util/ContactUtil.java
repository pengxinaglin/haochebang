...
import com.haoche51.checker.entity.TransFailBuyerEntity;
...
public class ContactUtil {
	 ...
	 * @param groupId
	 */
	public static void insertPhoneContactBook(Context context, int groupId, TransFailBuyerEntity entity) {
		try {
			// 首先插入空值，再得到rawContactsId ，用于下面插值
			ContentValues values = new ContentValues();
			// 插入一条空值，以便得到 rawContactsId
